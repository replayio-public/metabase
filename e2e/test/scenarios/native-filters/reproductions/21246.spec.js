...
test.describe("issue 21246", () => {
  ...
  test("should be able to use sub-query referencing a GUI question and date based filters (metabase#21246)", async ({ context }) => {
...
async function resultAssertion(page, res) {
  await expect(page.locator(".ScalarValue").textContent()).toEqual(res);
}

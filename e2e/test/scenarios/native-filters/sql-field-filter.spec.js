...
test.describe("scenarios > filters > sql filters > field filter", () => {
  ...
  test.describe("ID filter", () => {
    ...
    test("should work when set initially as default value and then through the filter widget", async () => {
  ...
  test.describe("None", () => {
    ...
    test("should be runnable with the None filter being ignored (metabase#20643)", async () => {
    ...
    test("should let you change the field filter type to something else and restore the filter widget (metabase#13825)", async () => {
      // eslint-disable-next-line no-unscoped-text-selectors -- deprecated usage

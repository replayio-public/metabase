...
test.describe("scenarios > filters > sql filters > basic filter types", () => {
  ...
  test.describe("should work for text", () => {
    ...
    test("when set through the filter widget", () => {
    ...
    test("when set as the default value for a required filter", () => {
  ...
  test.describe("should work for number", () => {
    ...
    test("when set as the default value for a required filter (metabase#16811)", () => {
      SQLFilter.toggleRequired();
  ...
  test("displays parameter field on desktop and mobile", () => {
    SQLFilter.enterParameterizedQuery(
  ...
  // flaky test (#19454)
  test.skip("should show an info popover when hovering over fields in the field filter field picker", () => {

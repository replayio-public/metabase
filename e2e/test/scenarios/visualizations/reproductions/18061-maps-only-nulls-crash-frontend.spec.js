...
test.describe("issue 18061", () => {
  ...
  test.describe("scenario 1: question with a filter", () => {
    test('should handle data sets that contain only null values for longitude/latitude (metabase#18061-1)', async ({ page }) => {
  ...
  test.describe("scenario 2: dashboard with a filter", () => {
    test('should handle data sets that contain only null values for longitude/latitude (metabase#18061-2)', async ({ page }) => {
  ...
  test.describe("scenario 3: publicly shared dashboard with a filter", () => {
    test('should handle data sets that contain only null values for longitude/latitude (metabase#18061-3)', async ({ page }) => {

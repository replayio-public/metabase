...
test.describe("scenarios > visualizations > bar chart", () => {
  ...
  test.describe("with binned dimension (histogram)", () => {
    test("should filter out null values (metabase#16049)", async () => {
      visitQuestionAdhoc({
        dataset_query: {
          type: "query",
          query: {
  ...
  test.describe("with very low and high values", () => {
    test("should display correct data values", async () => {
      visitQuestionAdhoc({
        display: "bar",
        dataset_query: {
          type: "native",
  ...
  test.describe("with stacked bars", () => {
    test("should drill-through correctly when stacking", async () => {
      visitQuestionAdhoc({
        dataset_query: {
          type: "query",
          query: {
  ...
  test("supports up to 100 series (metabase#28796)", async () => {
    visitQuestionAdhoc({
      display: "bar",
      dataset_query: {
        database: SAMPLE_DB_ID,

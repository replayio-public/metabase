...
test.describe("scenarios > visualizations > maps", () => {
  ...
  test('should display a pin map for a native query', async ({ page }) => {
  ...
  test('should suggest map visualization regardless of the first column type (metabase#14254)', async ({ page }) => {
  ...
  test('should not assign the full name of the state as the filter value on a drill-through (metabase#14650)', async ({ page }) => {
  ...
  test('should display a tooltip for a grid map without a metric column (metabase#17940)', async ({ page }) => {
    visitQuestionAdhoc({
      display: "map",
      dataset_query: {
        database: SAMPLE_DB_ID,
  ...
  test('should render grid map visualization for native questions (metabase#8362)', async ({ page }) => {
    visitQuestionAdhoc({
      dataset_query: {
        type: "native",
        native: {

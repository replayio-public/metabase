...
test.describe("scenarios > visualizations > table", () => {
  ...
  test('should show field metadata in a popover when hovering over a table column header', async () => {
    const ccName = "Foo";
  ...
  test('should show field metadata popovers for native query tables', async () => {
  ...
  test.skip('should close the colum popover on subsequent click (metabase#16789)', async () => {
    openPeopleTable({ limit: 2 });

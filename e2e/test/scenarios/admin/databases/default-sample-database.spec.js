...
test.describe("scenarios > admin > databases > sample database", () => {
  ...
  test('database settings', async ({ page }) => {
  ...
  test('database actions sidebar', async ({ page }) => {
  ...
  test('updates databases list in Database Browser after bringing sample database back', async ({ page }) => {
  ...
  describeEE("custom caching", () => {
    test('should set custom cache ttl', async ({ page }) => {

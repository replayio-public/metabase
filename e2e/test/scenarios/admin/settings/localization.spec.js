...
test.describe("scenarios > admin > localization", () => {
  ...
  test('should not display excessive options in localization tab (metabase#14426)', async () => {
...
async function setFirstWeekDayTo(day) {
  await cy.request("PUT", "/api/setting/start-of-week", {

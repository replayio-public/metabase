...
test.describe("scenarios > question > new", () => {
  ...
  test.describe("data picker", () => {
    ...
    test('new question data picker search should work for both saved questions and database tables', async () => {
      ...
      // eslint-disable-next-line no-unscoped-text_selectors -- deprecated usage
  ...
  test("should remove `/notebook` from URL when converting question to SQL/Native (metabase#12651)", async () => {
    openOrdersTable();
  ...
  test("should suggest the currently viewed collection when saving question", async () => {

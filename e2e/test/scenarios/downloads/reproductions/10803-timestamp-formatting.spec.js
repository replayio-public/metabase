...
test.describe("issue 10803", () => {
  ...
  testCases.forEach(fileType => {
    test(`should format the date properly for ${fileType} in saved questions (metabase#10803)`, async ({ page }) => {
    ...
    test(`should format the date properly for ${fileType} in unsaved questions`, async ({ page }) => {

...
describe.skip("issue 18219", test.describe("issue 18219", () => {
  ...
  testCases.forEach(fileType => {
    test(`should format temporal units on export (metabase#18219) for ${fileType}`, async () => {
      const questionId = await cy.createQuestion(questionDetails);

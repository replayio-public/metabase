...
test.describe("scenarios > embedding > native questions", () => {
  ...
  test.describe("UI", () => {
    ...
    test("should not display disabled parameters", async () => {
  ...
  test.describe("API", () => {
    ...
    test("should hide filters via url", async () => {
    ...
    test("should set multiple filter values via url", async () => {
      cy.get("@questionId").then(questionId => {
        cy.request("PUT", `/api/card/${questionId}`, {
          enable_embedding: true,
          embedding_params: {
    ...
    test("should lock all parameters", async () => {
      cy.get("@questionId").then(questionId => {
        cy.request("PUT", `/api/card/${questionId}`, {
          enable_embedding: true,
          embedding_params: {

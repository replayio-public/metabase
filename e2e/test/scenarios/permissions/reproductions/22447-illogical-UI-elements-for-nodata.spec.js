...
test.describe("UI elements that make no sense for users without data permissions (metabase#22447, metabase##22449, metabase#22450)", () => {
  ...
  test('should not offer to save question to users with no data permissions', async ({ page }) => {
    cy.signIn("nodata");
  ...
  test.skip("should not show visualization or question settings to users with block data permissions", async ({ page }) => {
    cy.onlyOn(isEE);

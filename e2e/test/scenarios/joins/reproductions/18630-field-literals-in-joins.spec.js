...
test.describe("issue 18630", () => {
  ...
  test("should normally open queries with field literals in joins (metabase#18630)", async ({ page }) => {
    cy.createQuestion(
    ...
    await page.locator('text="test question"');
  });
});

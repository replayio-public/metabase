...
test.describe("scenarios > question > view", () => {
  ...
  test.describe("apply filters without data permissions", () => {
    ...
    test("should show filters by search for Vendor", async ({ page }) => {
      ...
      await page.locator('text=VENDOR').first().click();
      popover().within(() => {
    ...
    test("should be able to filter Q by Category as no data user (from Q link) (metabase#12654)", async ({ page }) => {
      cy.signIn("nodata");
      visitQuestion(4);
    ...
    test("should be able to filter Q by Vendor as user (from Dashboard) (metabase#12654)", async ({ page }) => {

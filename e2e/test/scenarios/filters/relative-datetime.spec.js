...
test.describe("scenarios > question > relative-datetime", () => {
  ...
  test.describe("starting from", () => {
    ...
    STARTING_FROM_UNITS.forEach(unit =>
      test(`should work with Past filters (${unit} ago)`, () => {
        nativeSQL([
          now,
          date([[-1, unit]]),
          date([[-14, unit]]),
    ...
    STARTING_FROM_UNITS.forEach(unit =>
      test(`should work with Next filters (${unit} from now)`, () => {
        nativeSQL([
          now,
          date([[1, unit]]),
          date([[14, unit]]),
    ...
    test("should not clobber filter when value is set to 1", () => {
      openOrdersTable();
  ...
  test.describe("basic functionality", () => {
    test("starting from should contain units only equal or greater than the filter unit", () => {
      openOrdersTable();
    ...
    test("should go back to shortcuts view", () => {
      openOrdersTable();
    ...
    test("current filters should work (metabase#21977)", () => {
      openOrdersTable();
    ...
    test("Relative dates should default to past filter (metabase#22027)", () => {
      openOrdersTable();
    ...
    test("should change the starting from units to match (metabase#22222)", () => {
      openOrdersTable();
      ...
      assertOptions(["months ago", "years ago"]);
    });

    test("should show correct datetime preview (metabase#22225)", () => {
      openOrdersTable();
    ...
    test("should allow changing values with starting from (metabase#22227)", () => {
      openOrdersTable();
    ...
    test("starting from option should set correct sign (metabase#22228)", () => {
      openOrdersTable();

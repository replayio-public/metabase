...
test.describe("scenarios > dashboard > filters > nested questions", () => {
  test.beforeEach(async () => {
    restore();
    cy.signInAsAdmin();
  });

  test('dashboard filters should work on nested question (metabase#12614, metabase#13186, metabase#18113)', async () => {
    const filter = {
      name: "Text Filter",
      slug: "text",
      id: "27454068",
  ...
  test('should be possible to use ID filter on a nested question (metabase#17212)', async () => {
    const baseQuestion = {

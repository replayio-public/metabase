...
test.describe("scenarios > metabot", () => {
  ...
  test("should allow to submit prompts based on the database", async () => {
  ...
  test("should allow to submit prompts based on models", async () => {
  ...
  test("should not allow to submit prompts when there are no models", async () => {
    enableMetabot();
    verifyNoHomeMetabot();
  });

  test("should not allow to submit prompts when metabot is not enabled", async () => {
    cy.createQuestion(MODEL_DETAILS, { wrapId: true, idAlias: "modelId" });
    verifyNoHomeMetabot();
  ...
  test("should not allow to submit prompts for a user without native permissions", async () => {
    cy.createQuestion(MODEL_DETAILS, { wrapId: true, idAlias: "modelId" });
    enableMetabot();
    cy.signIn("nodata");
    verifyNoHomeMetabot();
